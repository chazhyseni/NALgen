...
The main purpose of this article is to break down the simulation steps: landscape generation and simulation of genotypes based on the generated landscapes.<!--more-->

<a href="https://github.com/chazhyseni/NALgen/blob/master/data" target="_blank">Simulated Genotypes (50 selected and 500 neutral biallelic loci (SNPs), separately and combined): two migration coefficients (m=0.1 and 0.5) x two levels of landscape complexity (low and high) x two levels of landscape permeability (low and high)</a>
